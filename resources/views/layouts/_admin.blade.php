            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <li><i class="fa fa-id-badge"></i><a href="{{ route('category.index') }}">Category manegement</a></li>
                        <li><i class="fa fa-bars"></i><a href="{{ route('category.trash') }}">Category trash</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-id-badge"></i><a href="{{ route('product.index') }}">Product manegement</a></li>
                        </ul>
                    </li> 
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-id-badge"></i><a href="{{ route('users.index') }}">users manegement</a></li>
                        </ul>
                    </li>    
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content ">
            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                            <div class="card-header"><strong>@yield("title")</strong></div> 
